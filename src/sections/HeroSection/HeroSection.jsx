...
export default function HeroSection() {
    return (
        <section id="home" className="hero-section">
            ...
            {/* O "Campo de Conexões Flutuantes" (Ícones de Hardware/Dados - MAIS PEÇAS) */}
            ...
            <div className="hero-content">
                ...
                <h1 className="hero-title">
                    Monetize seus ativos de TI com <span className="text-eco">segurança auditável.</span>
                </h1>

                <p className="hero-subtitle">
                    Transforme hardware obsoleto em receita e garanta o compliance ESG da sua empresa de ponta a ponta. Nossa IA precifica, o mercado compra e você recebe com risco zero.
                </p>

                <div className="hero-buttons">
                    <button className="btn-primary">Entrar na Lista de Espera</button>
                    <button className="btn-secondary">Entenda a Plataforma ↓</button>
                </div>
